...
if __name__ == '__main__':
    ...
    if Flag:
        ...
        for year in range(2020,2026):
            file_name = f"/Users/fantant/Desktop/Financial-Analysis/annualReportTools/annualReport/年报链接_{year} - 唐哲.xlsx"
            # 创建存储文件的文件夹路径，如有需要请修改
            pdf_dir = f'annualFiles/{year}/pdf_Format'
            txt_dir = f'annualFiles/{year}/txt_Format'
